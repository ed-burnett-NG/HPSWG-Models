...
| ✓* | Heritage Sample | Cross-reference to Sample; Removed; Sample; Created | S13 | -- |  (A reference to the sample that was taken in this sample taking event – Class to be Confirmed as dual S13/E22 construct may be needed for the sample.) |
