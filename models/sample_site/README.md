...
| ✓ | Unique System Label or ID#-1 | Database or System ID; Sample Site System ID | E41 | ![behaviour: System ID](https://img.shields.io/badge/%2F%2F-System%20ID-57606a) | Required within some documentation or database systems, such as ResearchSpace required label. |
...
| ✓ | E22/S13: Heritage Sample | Sample | E22/S13: Heritage Sample | ![behaviour: Select Entity](https://img.shields.io/badge/%2F%2F-Select%20Entity-8250df) | -- |
| ✓ | Sample Taking | Cross-reference to Sample Taking; Sample Creation | S2 | ![behaviour: Select Entity](https://img.shields.io/badge/%2F%2F-Select%20Entity-8250df) | The event in which a material sample was physically removed from the painting. |
...
| Optional | EX_Digital_Image_Region | Image Annotation; Digital Image Region | EX_Digital_Image_Region | ![behaviour: Select Entity](https://img.shields.io/badge/%2F%2F-Select%20Entity-8250df) | A defined digital region on an image corresponding to the physical sample site on the painting. |
